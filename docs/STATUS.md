...
- [CX] 已验证：当前 G2A Web 真实 corpus canary 超时；4 路 Ollama `qwen3-vl:8b` 在默认 120 秒内也超时并安全重试，改为单路 300 秒后 46.9 秒完成 1 条真实预标注（allow/0.95）。质量库现为预标注成功 1、排队 1,099，人工决定 0、已收敛样本 0；未写生产头像。当前证据不支持直接开启 4 路本机长批次
